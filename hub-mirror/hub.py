...
class Hub(object):
    def __init__(
        ...
        self.src_endpoint = (src_endpoint or "").strip()
        self.dst_endpoint = (dst_endpoint or "").strip()
        if self.dst_type == "gitee":
            ...
            gitlab_host = self.dst_endpoint or "gitlab.com"
        ...
        if self.src_type == "gitee":
            ...
            gitlab_host = self.src_endpoint or "gitlab.com"
